...
//todo: je kan niet op 'add' drukken als je allen iets verwijdert hebt + de labels kloppen niet want als je alleen iets verwijdert dan moet er geen 'add' staan (miss save changes???)
