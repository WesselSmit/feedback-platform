<template>
  <svg  width="45" height="45">
    <path class="visualisation__marker-glow" d="M22.5 45a22.5 22.5 0 100-45 22.5 22.5 0 000 45z" />
    <path class="visualisation__marker-background" d="M19 16l-2 1.5-1 5 3.5 6.5 2.5 1.5 2-2 2.5-2 1.5-3 .5-2.5v-1.5l-2-2.5-2-2h-2L19 16z" />
